...
export default function ClearingExportsPage() {
  ...
  useEffect(() => {
    async function loadCases() {
      ...
      if (res.data) {
        // filter exports or display similar list representing exports
        setCases(res.data);
      }
    }
    loadCases();
    ...
    <div className="space-y-8">
      <div>
        <h2 className="text-3xl font-black text-slate-800 tracking-tight flex items-center space-x-3">
          ...
          <span>Export Clearing Declarations</span>
        </h2>
        <p className="text-gray-500 mt-2 font-medium">
          Monitor outgoing cargo SAD500 declarations, border exit clearance, and compliance reviews.
        </p>
      </div>
      ...
      <div className="relative w-full">
        ...
        <input
          type="text"
          placeholder="Search exports by SAD500 reference, border post, cargo..."
          value={searchTerm}
          ...
          <table className="w-full text-left text-xs font-semibold text-gray-500">
            <thead className="bg-gray-50 text-gray-400 uppercase tracking-widest text-[10px] border-b border-gray-100">
              <tr>
                ...
                <th className="px-6 py-4">Export cargo</th>
