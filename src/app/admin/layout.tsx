      ...
      <div className="flex h-screen bg-gray-950 text-white font-sans antialiased">
        ...
        <aside className="w-64 flex-shrink-0 border-r border-gray-800 bg-gray-900 min-h-screen flex flex-col hidden md:flex">
          <div className="h-16 flex items-center px-6 border-b border-gray-800 bg-gray-900">
            <h1 className="text-lg font-extrabold text-yellow-500 tracking-wider uppercase flex items-center space-x-2">
              <span className="bg-yellow-500 text-black px-1.5 py-0.5 rounded font-black">DFS</span>
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <header className="h-16 border-b border-gray-800 bg-gray-900 flex items-center justify-between px-6 sticky top-0 z-30">
            <div className="flex items-center space-x-3 text-sm text-gray-400">
              ...
              <span>System Status: <strong className="text-green-400">Operational</strong></span>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="h-9 w-9 rounded-xl bg-yellow-500/10 border border-yellow-500/20 flex items-center justify-center text-yellow-500 font-bold">
          ...
          {/* Page body */}
          <main className="flex-1 overflow-y-auto bg-[#0b0c10] p-6 sm:p-8">
            {children}
          </main>
        </div>
      </div>
